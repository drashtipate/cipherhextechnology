...
@section('title', 'Kids Learning')
@section('content')

<section class="section pb-4 pt-0 success-story-block">
    <img class="bg-body-top-bg" style="bottom: auto; top: 140px;width: 100%;" src="{{ asset('images/19.jpg') }}" alt="Animal Planet - 3D, VR, 360 - Portfolio">
                ...
                <div class="blog-dediated-block" style="height: 15rem;">
                    <div class="blog-status">
                        <div class="blog-date text-center" style="height: 15rem;width: 15rem;padding-top: 0px;background-color: #ffffff;">
                           <img src="{{ asset('img/kidslearning.png') }}" style="height: 100%;" />
                        </div>
                    </div>
                    <h2 style="margin-left: 9rem;">Kids Learning</h2>
                    <p class="caption-text" style="margin-left: 9rem;">Kids Learning</p>
