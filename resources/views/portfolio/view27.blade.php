...
@section('title', 'Black Card Entertainment')
@section('content')

<section class="section pb-4 pt-0 success-story-block">
    <img class="bg-body-top-bg" style="bottom: auto; top: 140px;width: 100%;" src="{{ asset('images/blackcardentertainment-banner.png') }}" alt="blackcard entertainment">
                ...
                <div class="blog-dediated-block" style="height: 15rem;">
                    <div class="blog-status">
                        <div class="blog-date text-center" style="height: 15rem;width: 15rem;padding-top: 0px;background-color: #ffffff;">
                           <img src="{{ asset('img/blackcardentertainment1.png') }}" style="height: 100%;" />
                        </div>
                    </div>
                    <h2 style="margin-left: 9rem;">Black Card Entertainment</h2>
                    <p class="caption-text" style="margin-left: 9rem;">THIS APPLICATION IS FOR BLACK CARD MEMBERS ONLY OR PEOPLE WANTING TO BUY A MEMBERSHIP</p>
