...
@section('title', 'ABC MeMonsters')
@section('content')

<section class="section pb-4 pt-0 success-story-block">
    <img class="bg-body-top-bg" style="bottom: auto; top: 140px;width: 100%;" src="{{ asset('images/abc-memonster-banner.png') }}" alt="Animal Planet - 3D, VR, 360 - Portfolio">
    ...
    <div class="container">
        <div class="row">
            <div class="col-md-10 mx-auto">
                <div class="blog-dediated-block" style="height: 15rem;">
                    <div class="blog-status">
                        <div class="blog-date text-center" style="height: 15rem;width: 15rem;padding-top: 0px;background-color: #ffffff;">
                           <img src="{{ asset('img/abc-memonster1.png') }}" style="height: 100%;" />
                        </div>
                    </div>
                    <h2 style="margin-left: 9rem;">ABC MeMonsters</h2>
                    <p class="caption-text" style="margin-left: 9rem;">Kids will enjoy learning the Alphabets with the MeMonsters.</p>
                ...
                <p>Kids will enjoy learning the Alphabets with the MeMonsters. ABC MeMonster is a cool, interactive and musical learning app for kids.</p>
                </br>
                <p>Rated Ages 1 - 5</p>
                </br>
